...
`version` is just a variable that keeps track of the current version. We provide it in advance for any contingencies. **Note:** Available only in versions `1.1.1` and above.

...
[msemoji](https://www.npmjs.com/package/msemoji) 现已在 NPM 上可用。
...
1. `https://cdn.jsdelivr.net/gh/DellZHackintosh/msemoji@1.1.2/src/`（推荐。不过要记得，有挂掉的可能......）

2. `https://raw.gitmirror.com/DellZHackintosh/msemoji/main/src/`（请遵守`7ed.net`的使用说明，特别是**不要滥用**！）

3. `https://gh.sourcegcdn.com/DellZHackintosh/msemoji/1.1.2/src/`（来自 [Source Global CDN](https://www.sourcegcdn.com/)）同样**不要滥用**，同时不允许空 Referer 请求。
